                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        ...
                        <ul class="list-group list-group-unbordered mb-3">
                            <!-- permission -->
                            <li class="list-group-item"><b>Uprawnienia <?php echo $permission['permissionUserEdit'] ? '<a class="badge badge-primary" data-toggle="collapse" aria-expanded="false" aria-controls="collapseChangePermission" href="#collapseChangePermission">Zmień</a>' : ''; ?></b> <a class="float-right"><?php echo $user['permissionName']; ?></a>
                            ...
                            <li class="list-group-item">
                                <b>Adres E-Mail <?php echo $userAccount ? '<a class="badge badge-primary" data-toggle="collapse" aria-expanded="false" aria-controls="collapseChangeEmail" href="#collapseChangeEmail">Zmień</a>' : ''; ?></b> <a class="float-right"><?php echo $user['email'] ?></a>
                                <div class="clearfix"></div>
