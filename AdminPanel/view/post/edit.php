                    ...
                    <div class='card card-secondary card-outline'>
                        <div class='card-header'>
                            ...
                            <div class="card-tools">
                                <button type="button" class="btn btn-tool" data-card-widget="collapse" data-toggle="tooltip" title="Ukryj/Pokaż"><i class="fas fa-minus"></i>
                                </button>
                            </div>
                        </div>
                        <div class='card-body'>
                            <div class="form-group was-validated">
                                <label>Nazwa</label>
                                <input type="text" minlength="3" class="form-control" name="title" placeholder="Tytuł posta" value="<?php echo $addPost ? '' : $post['title'] ?>"
                                       required>
