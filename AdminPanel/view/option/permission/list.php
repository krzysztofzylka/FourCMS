        ...
        <div class="card">
            <div class='card-header'>
                ...
                <div class="card-tools">
                    <a href="permissionAdd.html" class="btn btn-tool <?php echo !core::$module->account->checkPermission('option_permissionEdit') ? 'disabled' : '' ?>"
                       data-toggle="tooltip" data-placement="left" title="Dodaj kategorię"><i class="fas fa-plus"></i></a>
                </div>
            </div>
                ...
                <table class="table table-sm text-nowrap dataTable">
					...
					foreach ($permissionList as $item) {
						...
						foreach ($item['permission'] as $name) {
							$perm = $modelPermission->getPerm($name);
