                ...
                <div class="card card-primary card-outline">
                    <div class="card-body box-profile">
                        {block name=profileBox}
                            ...
                            <p class="text-center">
                            {if $userData_userAcc}
                                <a class="badge badge-primary" data-toggle="collapse" aria-expanded="false"
                                   aria-controls="collapseChangeName" href="#collapseChangeName">
                                        ...
                                        <form method="POST">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" class="form-control" placeholder="Nazwa"
                                                       value="{$userData_data['name']}">
                                            </div>
                                            <button type="submit" name="save_name" class="btn btn-primary btn-block">
                                                Zmień nazwę
                                            </button>
                                        </form>
                                    </div>
                            ...
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <li class="list-group-item">
                                    <b>Uprawnienia
                                        {if $userPermission['permissionUserEdit']}
                                            <a class="badge badge-primary" data-toggle="collapse" aria-expanded="false"
                                               aria-controls="collapseChangePermission"
                                               href="#collapseChangePermission">Zmień</a>
                                        {/if}
                                    </b>
                                    <a class="float-right">
                                            ...
                                            <div class="card card-body">
                                                <form method="POST">
                                                    ...
                                                    <button type="submit" name="save_permission"
                                                            class="btn btn-primary btn-block">Zmień uprawnienia
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
                                ...
                                <li class="list-group-item">
                                    <b>Adres E-Mail
                                        {if $userData_userAcc}
                                            <a class="badge badge-primary" data-toggle="collapse" aria-expanded="false"
                                               aria-controls="collapseChangeEmail" href="#collapseChangeEmail">Zmień</a>
                                        {/if}
                                                ...
                                                <form method="POST">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" name="email" class="form-control"
                                                               placeholder="Nazwa" value="{$userData_data['email']}">
                                                    </div>
                                                    <button type="submit" name="save_email"
                                                            class="btn btn-primary btn-block">Zmień nazwę
                                                    </button>
                                                </form>
                                            </div>
                                        </div>
                ...
                <div class="card">
                    <div class="card-header p-2">
                        <ul class="nav nav-pills">
                            {block name=userMenu}
                                <li class="nav-item"><a class="nav-link active" href="#posts" data-toggle="tab"
                                                        style="">Posty</a></li>
                                {if $userData_userAcc}
                                    <li class="nav-item"><a class="nav-link" href="#settings" data-toggle="tab"
                                                            style="">Ustawienia</a></li>
                                {/if}
                            {/block}
                        </ul>
                    </div>
                        ...
                        <div class="tab-content">
                            {block name=userTab}
                                ...
                                <div class="tab-pane active" id="posts">
                                    <div class="alert alert-warning">Opcja będzie udostępniona w późniejszych wersjach
                                    </div>
                                </div>
                                <!-- setting -->
                                {if $userData_userAcc}
                                    <div class="tab-pane" id="settings">
                                        <a href="userChangePassword.html" class="btn btn-secondary"><i
                                                    class="nav-icon fas fa-key"></i> Zmiana hasła</a>
                                    </div>
                                {/if}
                            {/block}
                        </div>
