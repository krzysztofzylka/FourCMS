...
INSERT INTO `AP_groupPermission` (`id`, `name`, `permission`)
	VALUES (1, 'Administrator', '[\"all_granted\"]'),
		   (2, 'Użytkownik', '[]');
...
INSERT INTO `config` (`id`, `name`, `value`)
	VALUES (1, 'adminPanel_loginMessage',
			'Zaloguj się do panelu administracyjnego <a href=\"https://krzysztofzylka.pl/\">FourCMS</a>'),
...
INSERT INTO `jumbotron` (`name`, `value`)
	VALUES ('header', 'Nagłówek telebimu'),
		   ('show', '1'),
		   ('text', 'Treść telebimu'),
		   ('url', '#');
...
INSERT INTO `menu` (`id`, `name`, `link`, `position`)
	VALUES (1, 'Strona główna', 'index.php', 0);
...
INSERT INTO `permissionList` (`permName`, `name`, `description`)
	VALUES ('all_granted', 'Wszystkie uprawnienia', 'Wszystkie uprawnienia'),
		   ...
		   ('permissionUserEdit', 'Edycja uprawnień użytkownika',
			'Opcja ta zezwala użytkownikowi na edycję uprawnień innych użytkowników'),
		   ...
		   ('option_permissionEdit', 'Zarządzanie uprawnieniami',
			'Opcja umożliwiająca edycję/dodanie nowej grupy uprawnień'),
		   ...
		   ('blockUser', 'Zablokowanie/Odblokowanie użytkowników',
			'Pozwolenie na zablokowanie/odblokowanie użytkownika'),
		   ('moduleAdd', 'Strona instalacyjna modułów',
			'Uprawnienie pozwala na dostęp do strony instalacyjnej modułów z serwera'),
		   ('option_userResetPassword', 'Reset hasła użytkownika', 'Reset hasła użytkownika');
...
INSERT INTO `post` (`id`, `title`, `date`, `text`, `user`, `url`, `type`, `hidden`)
	VALUES (1, 'Strona główna', '0000-00-00 00-00-00', 'Witaj w pierwszym poście twojego CMSa', 1, 'auto', 'post', 0);
